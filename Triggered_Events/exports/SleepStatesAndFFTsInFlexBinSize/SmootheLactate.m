...
numchanged=abs(FlipMatrix(11,:)-mean(FlipMatrix(1:10,:)))./((std(FlipMatrix(1:10,:))/sqrt(10))*5)>1; %Does absolute value of ((value minus mean of previous five)/five*SEM of previous ten) exceed 1?
