...
10) locs_of_start_times (line 166 in PROCESSLBATCHMODE.m) is probably wrong and causing problems.  Make it more robust and general
like I did with the calculation of epoch_length_in_seconds.  Actually, this is computed correctly for the file that 
