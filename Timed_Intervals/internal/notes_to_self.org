...
[X] Re-running SleepReport.m for each of the human-scored .txt files.  I don't need to redo computer scored because they 
...
[X] I need to organize my github stuff.  push changes today from todayscode4 and make sure I got everything. Copy Epoch-Based into another 
...
Everything is in mrempe\Epoch-Based-Processing now.  
...
SLEEPREPORT.m works fine for BA-121140 but breaks when running more than one at once.  FIXED: I found the problem: I was using too many epochs. 
...
[X] change .m file names that are all caps to not all caps  TESTPCASCOREBATCHMODE.m and AUTOSCOREBATCHMODE.m so other people can know 
which script is the main one in my directory. 

* Friday, August 15, 2014
Run the Sleep Report Statistics for 8640 epochs (starting at 10 AM) for the following:
BA 10sec human  (saved in strain_study_data\BA\compareto2sec with 10sec_8640epochs_human_scored in file names)
BA 10sec autoscored (saved in strain_study_data\BA\compareto2sec\autoscored with 8640epochs_machinescored in file names)
BA 2sec  human   (saved in strain_study_data\2SecondEpochs\BA with 2sec_8640epochs_human_scored in the file names)
BA 2sec  autoscored (saved in strain_study_data\2SecondEpochs\BA\autoscored with 2sec_8640epochs_human_scored in the file names))
BL 10sec human (saved in strain_study_data\BL\compareto2sec\ with 10sec_8640epochs_human_scored in file names)
BL 10sec autoscored (saved in strain_study_data\BL\compareto2sec\autoscored with 10sec_8640epochs_machine_scored in file names)
BL 2sec  human (saved in strain_study_data\2SecondEpochs\BL\ with BL2sec8640epochs_human_scored in file name)
BL 2sec  autoscored  (saved in strain_study_data\2SecondEpochs\BL\autoscore with BL2sec8640epochs_machine_scored in file name)
