...
%
% This function uses autoscore.m (a downloaded file from Rytkonen et al J. Neurosci Methods 2011)
% to automatically score a .edf file that has been partially scored. 
% A good practice is to score about 5-10% of the file. 
% autoscore.m bins the data into 21 bins using a log scale 
% and then runs them through classify.m to do the Naive Bayes.  
% This requires a partially scored edf file and a .txt file.
%
% INPUTS:
% signal:  'EEG1' or 'EEG2'
